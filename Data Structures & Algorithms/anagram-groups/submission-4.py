class Solution:
    def groupAnagrams(self, strs: List[str]) -> List[List[str]]:
        ...
        # space complaexity: O(n*k) --> the dictionary stores all the strings as the values and the size 26 arrays as the keys. 26 is a constant number so does not matter
